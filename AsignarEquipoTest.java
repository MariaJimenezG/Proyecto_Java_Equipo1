...
class AsignarEquipoTest {
    ...
    /* Asignar jugador que exista, pero no tenga edad(es decir, habéis creado el jugador pero no habéis puesto el nombre con setnombre) */
    @Test
    ...
    void equipoRankingInvalido() {
        ...
        assertEquals(nombreEquipo ,asignarEquipo.getEquipo().getNombreEquipo());
        assertEquals(0, asignarEquipo.getEquipo().getRanking());
    }
